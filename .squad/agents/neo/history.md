...
### 2026-07-28T17:36:00+02:00 — Issue #37 AI generation disclosure
- Added the pre-submit AI generation disclosure to the card-generation form and covered its required assertions with an acceptance test.
- The wording states that Azure OpenAI / Foundry inference processing may occur outside the European Union while application data at rest remains in France Central, preserving the corrected GlobalStandard routing decision.
