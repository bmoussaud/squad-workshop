...
- 2026-07-30T11:16:49.586+02:00 Azure PR-environment analysis: Repository inspection confirmed two core workflow defects—`eligible` is consumed as a job output without being declared, and Container App selection is ambiguous. Non-zero minimum replicas, fixed per-PR Foundry names, and disabled live validation are repository-visible concerns; live Azure state was not verified.

- 2026-07-30T11:31:20.176+02:00 private-network consolidation feasibility: A single external VNet-integrated Container Apps environment can retain public application ingress and private Blob access. The legacy app ingress is internal, not disabled. Any consolidation remains unapproved and must pass live inventory plus ingress, DNS, private-endpoint, identity, deployment, and rollback validation before deletion.
