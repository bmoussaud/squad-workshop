...
<!-- native-bicep-fallback: infra/foundry.bicep/policyBlocklist | Microsoft.CognitiveServices/accounts/raiBlocklists | The selected Cognitive Services account AVM does not expose RAI blocklist creation. -->
<!-- native-bicep-fallback: infra/foundry.bicep/policyBlocklistItems | Microsoft.CognitiveServices/accounts/raiBlocklists/raiBlocklistItems | The selected Cognitive Services account AVM does not expose RAI blocklist item creation. -->
